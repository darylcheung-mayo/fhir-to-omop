//
// Data Value Object (DVO) for fhir_to_omop_ethnicity
//
...
public class FhirToOmopEthnicityDvo implements Dvo {

    //
    // tableName
    //
    
    public static final String TABLE_NAME = "fhir_to_omop_ethnicity";
