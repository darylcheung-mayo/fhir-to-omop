...
import org.nachc.tools.fhirtoomop.util.mapping.GenderMappingR4;
import org.nachc.tools.fhirtoomop.util.mapping.RaceMapping;
import org.nachc.tools.omop.yaorma.dvo.ConceptDvo;
import org.nachc.tools.omop.yaorma.dvo.PersonDvo;

public class OmopPersonBuilderR4 {
	...
	public OmopPersonBuilderR4(FhirPatient fhirPatient, OmopPerson omopPerson, Connection conn) {
	...
	private void mapGender(PatientParser patient, PersonDvo dvo, Connection conn) {
		...
		Integer genderId = GenderMappingR4.getOmopConceptForFhirCode(gender);
