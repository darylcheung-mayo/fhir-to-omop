...
public class OmopConditionFromProcedureR4 {
	...
	public OmopConditionFromProcedureR4(FhirPatient fhirPatient, ProcedureParser parser, ConceptDvo conceptDvo, OmopPerson omopPerson, Connection conn) {
	...
	public ConditionOccurrenceDvo build() {
		...
		int measurementId = FhirToOmopIdGenerator.getId("condition_occurrence", "condition_occurrence_id");
