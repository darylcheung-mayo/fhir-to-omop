...
public class OmopVisitOccurrenceBuilderR4 {
	...
	public OmopVisitOccurrenceBuilderR4(FhirPatient fhirPatient, OmopPerson omopPerson, Connection conn) {
	...
	private VisitOccurrenceDvo getVisitOccurrenceDvo(EncounterParser enc, PersonDvo person, Integer visitOccurrenceId) {
		...
		ConceptDvo visitConcept = FhirToOmopConceptMapperR4.getOmopConceptForFhirCoding(encounterType, conn);
