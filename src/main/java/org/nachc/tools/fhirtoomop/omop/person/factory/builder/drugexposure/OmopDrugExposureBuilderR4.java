...
public class OmopDrugExposureBuilderR4 {
	...
	public OmopDrugExposureBuilderR4(FhirPatient fhirPatient, OmopPerson omopPersonEverything, Connection conn) {
	...
	private DrugExposureDvo getDrugExposureDvo(MedicationRequestParser medReq) {
		...
		ConceptDvo conceptDvo = FhirToOmopConceptMapperR4.getOmopConceptForFhirCoding(medicationCoding, conn);
		if (conceptDvo != null) {
