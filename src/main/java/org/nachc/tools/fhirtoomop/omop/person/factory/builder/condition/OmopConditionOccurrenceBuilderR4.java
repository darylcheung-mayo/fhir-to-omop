...
public class OmopConditionOccurrenceBuilderR4 {
	...
	public OmopConditionOccurrenceBuilderR4(FhirPatient fhirPatient, OmopPerson omopPerson, Connection conn) {
	...
	private void buildConditionList() {
		...
		for (ConditionParser con : conList) {
			...
			ConceptDvo conceptDvo = FhirToOmopConceptMapperR4.getOmopConceptForFhirCoding(con.getCoding(), conn);
